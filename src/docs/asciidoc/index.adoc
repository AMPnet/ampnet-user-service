...
=== Application config
Config value is an arbitrary JSON.

.Request
include::{snippets}/PublicControllerTest/mustBeAbleToGetCoopConfig/http-request.adoc[]
.Response
include::{snippets}/PublicControllerTest/mustBeAbleToGetCoopConfig/http-response.adoc[]
