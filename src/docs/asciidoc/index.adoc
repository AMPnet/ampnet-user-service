...
==== Find by email
.Request
include::{snippets}/AdminControllerTest/mustBeAbleToFindUserByEmail/http-request.adoc[]
.Response
include::{snippets}/AdminControllerTest/mustBeAbleToFindUserByEmail/http-response.adoc[]
