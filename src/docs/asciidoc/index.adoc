...
=== Veriff
Veriff is used as KYC provider. For code explanation in `decision` response see: https://developers.veriff.com/#response-and-error-codes
...
.Request
include::{snippets}/IdentyumControllerTest/mustBeAbleToVerifyAccount/http-request.adoc[]
.Response
include::{snippets}/IdentyumControllerTest/mustBeAbleToVerifyAccount/http-response.adoc[]
